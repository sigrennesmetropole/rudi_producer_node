...
const DEFAULT_CONF = {
    ...
    auth: {
        ...
        system_users: {
            "admin":       [   4, "XXXXXXXX", [ "admin", "delegate" ], "./keys/mediapriv.pem" ], // XXXX.. can be replaced by a unix password
            "rudimanager": [ 101, "XXXXXXXX", [ "auth" ], "./adminpub.pem" ],
            "rudiprod":    [ 102, "XXXXXXXX", [ "producer" ], "" ],
            "rudiadmin":   [ 103, "XXXXXXXX", [ "monitor", "producer" ], "" ]
        },
